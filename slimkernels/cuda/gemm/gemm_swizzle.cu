...
template<int BLOCK_DIM_M,int BLOCK_DIM_N,int WARP_TILE_DIM_M,int WARP_TILE_DIM_N,int THREAD_NUM>
struct Index{
...
__device__ void mma_tile(MMAarguments &arg,
                        ...
                        ElementOutput *D,
                        Index<BLOCK_SHAPE_M,BLOCK_SHAPE_N,WARP_SHAPE_M,WARP_SHAPE_N,THREAD_NUM> &index){
...
__global__ void GEMM_MMA(MMAarguments arg){
    ...
    struct Index<BLOCK_SHAPE_M, BLOCK_SHAPE_N, WARP_SHAPE_M, WARP_SHAPE_N, THREAD_NUM> index;
    ...
    for(int i=0;i<iters;i++){
        ...
        __syncthreads();
        mma_tile<BLOCK_SHAPE_M,BLOCK_SHAPE_N,WARP_SHAPE_M,WARP_SHAPE_N,THREAD_NUM>(arg,tileA[i%3],tileB[i%3],C_fragment,C_fragment, index);
        if (i+2<iters){
